/**
  ...
  * @brief   This file contains all the description of the APS256XX 16bits-HSPI PSRAM memory.
  ******************************************************************************
  * @attention
  *
...
/* Includes ------------------------------------------------------------------*/
#include "aps256xx_conf_template.h"
...
/** @defgroup APS256XX_Exported_Types
  * @{
  */
...
/** @defgroup APS256XX_Exported_Constants
  * @{
  */
